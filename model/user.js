...
let User = sequelize.define('user',{
  ...
  assignedAreas:{ type:DataTypes.TEXT },
  commission:{ type:DataTypes.INTEGER },
  distributor:{ type:DataTypes.TEXT },
  gender:{ type:DataTypes.CHAR },
  image:{ type:DataTypes.TEXT },
  lco:{ type:DataTypes.INTEGER },
  mobile:{ type:DataTypes.TEXT },
  role:{ type:DataTypes.CHAR },
  wallet:{ type:DataTypes.BOOLEAN },
  walletBalance:{ type:DataTypes.INTEGER },
